...
defmodule ExBifrost.Model.CreateBusinessUnitGovernance200Response do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          :business_unit => ExBifrost.Model.CreateBusinessUnitGovernance200ResponseBusinessUnit.t() | nil
        }
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(
      :business_unit,
      :struct,
      ExBifrost.Model.CreateBusinessUnitGovernance200ResponseBusinessUnit
    )
  end
end
