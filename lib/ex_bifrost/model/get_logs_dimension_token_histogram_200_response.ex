...
defmodule ExBifrost.Model.GetLogsDimensionTokenHistogram200Response do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          :buckets => [ExBifrost.Model.GetLogsDimensionTokenHistogram200ResponseBucketsInner.t()] | nil,
  ...
  def decode(value) do
    value
    |> Deserializer.deserialize(:buckets, :list, ExBifrost.Model.GetLogsDimensionTokenHistogram200ResponseBucketsInner)
  end
end
