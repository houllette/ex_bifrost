...
defmodule ExBifrost.Model.CreateRole200Response do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          :role => ExBifrost.Model.ListRoles200ResponseRolesInner.t() | nil
        }
  ...
  def decode(value) do
    value
    |> Deserializer.deserialize(:role, :struct, ExBifrost.Model.ListRoles200ResponseRolesInner)
  end
end
