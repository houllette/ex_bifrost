...
defmodule ExBifrost.Model.GetLogsLatencyHistogram200Response do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          :buckets => [ExBifrost.Model.GetLogsLatencyHistogram200ResponseBucketsInner.t()] | nil,
  ...
  def decode(value) do
    value
    |> Deserializer.deserialize(:buckets, :list, ExBifrost.Model.GetLogsLatencyHistogram200ResponseBucketsInner)
  end
end
