...
defmodule ExBifrost.Model.CursorBedrockCountTokensRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          :input => ExBifrost.Model.CursorBedrockCountTokensRequestInput.t() | nil
        }
  ...
  def decode(value) do
    value
    |> Deserializer.deserialize(:input, :struct, ExBifrost.Model.CursorBedrockCountTokensRequestInput)
  end
end
