...
defmodule ExBifrost.Model.GetLogsProviderCostHistogram200Response do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          :buckets => [ExBifrost.Model.GetLogsProviderCostHistogram200ResponseBucketsInner.t()] | nil,
  ...
  def decode(value) do
    value
    |> Deserializer.deserialize(:buckets, :list, ExBifrost.Model.GetLogsProviderCostHistogram200ResponseBucketsInner)
  end
end
