...
defmodule ExBifrost.Model.ListTeams200Response do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          :teams => [ExBifrost.Model.ListTeams200ResponseTeamsInner.t()] | nil,
          :total => integer() | nil,
          :page => integer() | nil,
          :limit => integer() | nil,
  ...
  def decode(value) do
    value
    |> Deserializer.deserialize(:teams, :list, ExBifrost.Model.ListTeams200ResponseTeamsInner)
  end
end
