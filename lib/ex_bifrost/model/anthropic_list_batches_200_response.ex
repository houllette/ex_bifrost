...
defmodule ExBifrost.Model.AnthropicListBatches200Response do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          :data => [ExBifrost.Model.AnthropicListBatches200ResponseDataInner.t()] | nil,
  ...
  def decode(value) do
    value
    |> Deserializer.deserialize(:data, :list, ExBifrost.Model.AnthropicListBatches200ResponseDataInner)
  end
end
