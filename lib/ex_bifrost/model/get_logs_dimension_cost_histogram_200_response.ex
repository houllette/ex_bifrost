...
defmodule ExBifrost.Model.GetLogsDimensionCostHistogram200Response do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          :buckets => [ExBifrost.Model.GetLogsDimensionCostHistogram200ResponseBucketsInner.t()] | nil,
  ...
  def decode(value) do
    value
    |> Deserializer.deserialize(:buckets, :list, ExBifrost.Model.GetLogsDimensionCostHistogram200ResponseBucketsInner)
  end
end
