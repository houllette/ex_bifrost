defmodule ExBifrost.Api.MCPTest do
  use TestCase, async: true

  alias ExBifrost.Api.MCP
  ...
  # Add tests for each operation in ExBifrost.Api.MCP, for example:
  #
  #   test "lists things", %{bypass: bypass, conn: conn} do
  #     MockServer.expect_get(bypass, "/things", 200, %{things: []})
  #     assert {:ok, _response} = MCP.list_things(conn)
  #   end
