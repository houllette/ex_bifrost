defmodule ExBifrost.Api.LoggingTest do
  use TestCase, async: true

  alias ExBifrost.Api.Logging
  ...
  # Add tests for each operation in ExBifrost.Api.Logging, for example:
  #
  #   test "lists things", %{bypass: bypass, conn: conn} do
  #     MockServer.expect_get(bypass, "/things", 200, %{things: []})
  #     assert {:ok, _response} = Logging.list_things(conn)
  #   end
