defmodule ExBifrost.Api.SessionTest do
  use TestCase, async: true

  alias ExBifrost.Api.Session
  ...
  # Add tests for each operation in ExBifrost.Api.Session, for example:
  #
  #   test "lists things", %{bypass: bypass, conn: conn} do
  #     MockServer.expect_get(bypass, "/things", 200, %{things: []})
  #     assert {:ok, _response} = Session.list_things(conn)
  #   end
