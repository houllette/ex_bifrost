defmodule ExBifrost.Api.FilesTest do
  use TestCase, async: true

  alias ExBifrost.Api.Files
  ...
  # Add tests for each operation in ExBifrost.Api.Files, for example:
  #
  #   test "lists things", %{bypass: bypass, conn: conn} do
  #     MockServer.expect_get(bypass, "/things", 200, %{things: []})
  #     assert {:ok, _response} = Files.list_things(conn)
  #   end
